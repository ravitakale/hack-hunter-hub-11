      ...
      <section className="py-16 bg-gradient-to-r from-muted/30 via-muted/10 to-muted/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { value: "12", label: "Total Courses", color: "text-primary" },
              { value: "6", label: "Free Courses", color: "text-accent" },
              { value: "4.7", label: "Average Rating", color: "text-medium" },
              { value: "22K+", label: "Students Learning", color: "text-high" }
            ].map((stat, index) => (
          ...
          <Tabs defaultValue="all" className="space-y-8">
            ...
            <TabsContent value="all" className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filterCourses(allCourses).map((course, index) => (
            ...
            <TabsContent value="free" className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filterCourses(freeCourses).map((course, index) => (
                  <CourseCard key={course.id} course={course} index={index} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="paid" className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filterCourses(paidCourses).map((course, index) => (
                  <CourseCard key={course.id} course={course} index={index} />
                ))}
              </div>
            </TabsContent>
