      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center space-y-6">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/courses">
              <Button size="lg" className="px-8 py-6 text-lg font-semibold bg-gradient-to-r from-primary to-primary-glow hover:from-primary-glow hover:to-primary border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                <Play className="h-5 w-5 mr-2" />
                Start Learning
              </Button>
            </Link>
            <Link to="/courses/free">
              <Button variant="outline" size="lg" className="px-8 py-6 text-lg font-semibold hover:bg-accent hover:text-accent-foreground border-2 hover:border-accent transition-all duration-300 hover:scale-105">
          ...
          <Link to="/leaderboard">
            <Button variant="outline" className="px-6 py-3 hover:bg-primary hover:text-primary-foreground border-border/50 transition-all duration-300 group">
              <Trophy className="h-4 w-4 mr-2 group-hover:text-yellow-400" />
              Security Researchers Leaderboard
              <ArrowRight className="h-4 w-4 ml-2" />
            </Button>
          </Link>
        </div>
